...
func NewConfig(enabledCollectors []string, resourceAccessMethod, nodeName, clusterCategory string, localClusterID string, isMaster bool, namespace string) *Config {
	//监测当前系统平台
