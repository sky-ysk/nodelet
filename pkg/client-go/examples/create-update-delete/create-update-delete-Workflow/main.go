...
func main() {
	...
	if err != nil {
		...
		logs.Infof("created workflow", result)
	}
	...
	logs.Info("Updated workflow...")
	prompt()

	// List 所有Workflow
	logs.Info("listing 筛选的workflow")
	...
	//DeleteCollection 删除所有Spec.Name=demo-workflow的Workflow
