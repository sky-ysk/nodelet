...
func GetReference(scheme *runtime.Scheme, obj runtime.Object) (*apis.ObjectReference, error) {
	if obj == nil {
		return nil, ErrNilObject
	}
	if ref, ok := obj.(*apis.ObjectReference); ok {
...
func GetPartialReference(scheme *runtime.Scheme, obj runtime.Object, fieldPath string) (*apis.ObjectReference, error) {
