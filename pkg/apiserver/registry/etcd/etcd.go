...
func (c *REST) ConvertToTable(ctx context.Context, obj runtime.Object, tableOptions runtime.Object) (*meta.Table, error) {
	table := &metav1.Table{
	...
	var err error
	table.Rows, err = metatable.MetaToTableRow(obj, func(obj runtime.Object, m meta.Object, name, age string) ([]interface{}, error) {
