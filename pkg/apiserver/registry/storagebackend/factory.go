...
// //创建存储
// func Create(c ConfigForResource, newFunc, newListFunc func() runtime.Object, resourcePrefix string) (Interface, DestroyFunc, error) {
// 	switch c.Type {
...
// 创建客户端
func CreateEtcdClient(c ConfigForResource) (*Client, error) {
	switch c.Type {
	case StorageTypeETCD2:
