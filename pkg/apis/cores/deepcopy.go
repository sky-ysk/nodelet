...
func (in *GroupStatus) DeepCopyInto(out *GroupStatus) {
	*out = *in
	...
	if in.StoreTime != nil {
		in, out := &in.StoreTime, &out.StoreTime
		*out = new(Time)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.ServiceRestoreTime != nil {
		in, out := &in.ServiceRestoreTime, &out.ServiceRestoreTime
		*out = new(Time)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProcessLimit) DeepCopyInto(out *ProcessLimit) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProcessLimit.
func (in *ProcessLimit) DeepCopy() *ProcessLimit {
	if in == nil {
		return nil
	}
	out := new(ProcessLimit)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResourceSchema) DeepCopyInto(out *ResourceSchema) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	if in.ProcessLimits != nil {
		in, out := &in.ProcessLimits, &out.ProcessLimits
		*out = make([]ProcessLimit, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
