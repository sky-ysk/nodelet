...
// 修改1：
// 调度器代码: 触发CloudNode1节点资源不足事件,从publicserver0迁移到server1节点的调度器代码可能要修改一下
...
func main() {
	...
	runtime1_1_1_1FineGrainedControlService := "172.150.0.24" //A机器IP地址:publicserver0

	runtime1_1_1_1Input := []apis.Value{
		apis.Value{
			From: "/home/public/goprojects/test-0623/test/nodelet/switch/grpc-client-pod.yaml",
		},
	}
	...
	runtime1_2_1_1Input := []apis.Value{
		apis.Value{
			From: "/home/public/goprojects/test-0623/test/nodelet/switch/grpc-server-pod.yaml",
		},
	}
