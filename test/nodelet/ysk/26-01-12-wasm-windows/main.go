...
var group1_1Name = "G85"      // 第一个Task下的第一个GroupName
			...
			apis.ActionSpec{
				...
				Runtimes: []apis.RuntimeSpec{
					apis.RuntimeSpec{
						...
						Type:    apis.ByCommand,
						Command: []string{".\\power_rust_infer_server_v260111.exe"},
						...
						AbsDirectory: `C:\\project\\power_rust_infer_server_v260111\\power_rust_infer_server`,
					},
				},
			},
		},
