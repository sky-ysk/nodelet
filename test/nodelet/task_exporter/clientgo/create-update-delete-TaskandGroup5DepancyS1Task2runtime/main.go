...
// 1个group，1个Action，每个Action两个Runtime， 一共2个Runtime，为Service、Pod
func main() {
	...
	runtime1_1_1_2EnableFineGrainedControlService := "grpc-server-service"
	runtime1_1_1_2EnableFineGrainedControlPort := "50051"
						...
						Runtimes: []apis.Runtime{
							apis.Runtime{
								...
								Service: apis.Service{
									...
									Spec: apis.ServiceSpec{
										Selector: map[string]string{
											"app": "grpc-server",
										},
										Ports: []apis.ServicePort{
											apis.ServicePort{
												Protocol:   apis.ProtocolTCP,
												Port:       50051,
												TargetPort: apis.IntOrString{Type: apis.Int, IntVal: 50051},
											},
										},
										Type: apis.ServiceTypeClusterIP,
									},
								},
							},
							...
							//		ObjectMeta: metav1.ObjectMeta{Name: "grpc-server-pod", Namespace: "switch", Labels: map[string]string{"app": "grpc-server"}},
							//		Spec: apis.PodSpec{
							//			NodeSelector: map[string]string{"kubernetes.io/hostname": "server6"},
							...
							//	},
							//},
							apis.Runtime{ // 节点亲和性版本
								Name:                            runtime1_1_1_2Name,
								Type:                            apis.ByPod,
								Command:                         []string{},
								Args:                            []string{},
								Parents:                         []string{runtime1_1_1_2Name}, // 加入Parents
								Conditions:                      runtime1_1_1_2Condition,
								Image:                           "",
								EnvVar:                          []apis.EnvVar{apis.EnvVar{Name: "", Value: ""}},
								EnableFineGrainedControl:        runtime1_1_1_2FineGrainedControl,
								EnableFineGrainedControlService: runtime1_1_1_2EnableFineGrainedControlService,
								EnableFineGrainedControlPort:    runtime1_1_1_2EnableFineGrainedControlPort,
								Pod: apis.Pod{
									TypeMeta:   metav1.TypeMeta{Kind: "Pod", APIVersion: "v1"},
									...
									Spec: apis.PodSpec{
										Affinity: apis.Affinity{
											NodeAffinity: apis.NodeAffinity{
												RequiredDuringSchedulingIgnoredDuringExecution: apis.NodeSelector{
	...
	//如果已经存在，先删掉Service和Pod
	clientset := config.LoadConfig()
	DeletePod(clientset, podName, podNamespace)
	DeleteService(clientset, serviceName, serviceNamespace) // 删除k8s当中的Service
