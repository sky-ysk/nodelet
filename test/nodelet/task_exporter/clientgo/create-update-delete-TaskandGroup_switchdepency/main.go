...
func main() {
	...
	task1Name := "for_test_predict"   // 第一个Task的Name
	task1ID := "for_test_predictID-1" // 第一个Task的ID

	// group
	group1_1Name := "for_test_Train" // 第一个Task下的第一个GroupName
									...
									Formulas: []apis.ConditionFormula{
										apis.ConditionFormula{
											LeftValue: apis.ConditionValue{
												...
												Value:     "0",
												ValueType: "string",
												From:      "/home/public/goprojects/framework-0102/test/nodelet/task_exporter/dependency/requirements1.txt",
											},
