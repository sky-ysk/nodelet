...
func main() {
					...
					Spec: apis.ActionSpec{
						...
						Runtimes: []apis.Runtime{
							apis.Runtime{
								...
								Args:                     []string{"/home/public/workspace/modelfortest/model_torch/wine.py"},
					...
					Spec: apis.ActionSpec{
						...
						Runtimes: []apis.Runtime{
							...
							apis.Runtime{
								...
								Type:                     apis.ByCommand,
								Command:                  []string{"python"},
								Args:                     []string{"/home/public/workspace/heongtong_yolo_linux/wine.py"},
	...
	//							Type:                     apis.ByCommand,
	//							Command:                  []string{"python"},
	//							Args:                     []string{"/home/public/workspace/modelfortest/model_torch/mnist.py"},
	//							Parents:                  make([]string, 0), // 加入Parents
	...
	//							Type:                     apis.ByCommand,
	//							Command:                  []string{"python"},
	//							Args:                     []string{"/home/public/workspace/modelfortest/model_torch/Iris.py"},
	//							Parents:                  make([]string, 0), // 加入Parents
	...
	//							Type:                     apis.ByCommand,
	//							Command:                  []string{"python"},
	//							Args:                     []string{"/home/public/workspace/modelfortest/model_torch/Diabetes.py"},
	//							Parents:                  make([]string, 0), // 加入Parents
	...
	//							Type:                     apis.ByCommand,
	//							Command:                  []string{"python"},
	//							Args:                     []string{"/home/public/workspace/modelfortest/model_torch/breast_cancer.py"},
	//							Parents:                  make([]string, 0), // 加入Parents
